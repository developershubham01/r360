    ...
    <div>
      <Tabs orientation="vertical" value={activeTab} onValueChange={setActiveTab} className="flex flex-col md:flex-row gap-6 items-start">
        ...
        <TabsContent value="about">
          <div className="pb-6 max-w-3xl space-y-6">
            <div className="bg-white rounded-xl border border-gray-100 p-6">
              <h2 className="font-semibold text-gray-900 mb-4">{t('settings.aboutRestaurant360')}</h2>
              <p className="text-sm text-gray-600 mb-6">
                {t('settings.aboutDescription')}
              </p>
              <div className="space-y-3">
                <a href="https://github.com/FreeOpenSourcePOS/Restaurant360" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-brand hover:underline">
